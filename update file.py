...
def check_version():
    version_url = "https://raw.githubusercontent.com/ReaperAkira/owo_py/main/version.json"
    ...
    if remote_version != get_local_version():
        download_file("https://raw.githubusercontent.com/ReaperAkira/owo_py/main/update.py", "update.py")
